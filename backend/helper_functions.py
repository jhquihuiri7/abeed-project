...
def create_scatter_plot_fig(df):
    ...
    linear_y_fit_smooth, linear_equation, linear_r_squared = create_linear_best_fit(
        x, y, x_smooth
    )
    log_y_fit_smooth, log_equation, log_r_squared = create_log_best_fit(x, y, x_smooth)
    poly_y_fit_smooth, poly_equation, poly_r_squared = create_poly_best_fit(
        x, y, x_smooth
    )
    power_y_fit_smooth, power_equation, power_r_squared = create_power_best_fit(
        x, y, x_smooth
    )
