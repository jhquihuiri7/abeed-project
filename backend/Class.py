...
class Ops:
    ...
    def update_data_button(self, start_date_input: str, end_date_input: str, data_features_input: list[str], overrite_current_df=True):
        ...
        self.update_data(overrite_current_df=overrite_current_df)
    ...
    def update_data(self, overrite_current_df=True): # TODO: used to be update_df
        if self.data_features and self.start_date and self.end_date:
            db_names = []
            
            for feature in (self.data_features if overrite_current_df else list(set(self.data_features) - set(self.df.columns))):
