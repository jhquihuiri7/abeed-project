        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    ...
                    button(
                        text="Remove last",
                        id="remove_last_alias",
                        style=button_style + " hidden",
                    ),
                ],
...
def date_filter_dropdown():
    ...
    return [
        html.Div(
            children=[
                html.H2(
                    "Year", className="font-bold text-xl"
        ...
        html.Div(
            children=[
                html.H2(
                    "Month", className="font-bold text-xl"
        ...
        html.Div(
            children=[
                html.H2(
                    "Day of the week", className="font-bold text-xl"
        ...
        children=[
            html.Div(
                children=[
                    ...
                    dcc.Dropdown(
                        options=(
                            [feature for feature in client.session_data_features]
...
def custom_features_children(options, currentDropdownChildren):
    ...
    if currentDropdownChildren != [] and len(currentDropdownChildren) >= 2:
        children.append(
            button(text="Remove last", id="remove_last_alias", style=button_style)
        )
    else:
        children.append(
            button(
...
def remove_features_children(currentDropdownChildren):
    ...
    if currentDropdownChildren != [] and len(currentDropdownChildren) >= 2:
        currentDropdownChildren.append(
            button(text="Remove last", id="remove_last_alias", style=button_style)
        )
    else:
        currentDropdownChildren.append(
